...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.stack.addWidget(self.help_page) # Index 3
    ...
    def connect_signals(self):
        ...
        self.menu_page.go_to_editor.connect(lambda: self.stack.setCurrentIndex(2))
        self.menu_page.go_to_help.connect(lambda: self.stack.setCurrentIndex(3))
        self.menu_page.exit_app.connect(self.close)

        # 分割页信号
        self.seg_page.go_back.connect(lambda: self.stack.setCurrentIndex(0))
        # 编辑页信号
        self.editor_page.go_back.connect(lambda: self.stack.setCurrentIndex(0))
        # 说明页信号
